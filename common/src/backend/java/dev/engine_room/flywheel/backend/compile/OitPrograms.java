...
public class OitPrograms {
	private static final ResourceLocation FULLSCREEN = Flywheel.rl("internal/fullscreen.vert");
	static final ResourceLocation OIT_COMPOSITE = Flywheel.rl("internal/oit_composite.frag");
	static final ResourceLocation OIT_DEPTH = Flywheel.rl("internal/oit_depth.frag");
