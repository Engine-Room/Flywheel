...
public final class FrameUniforms extends UniformWriter {
	...
	public static void update(RenderContext context) {
		...
		ptr = writeFloat(ptr, ((LevelRendererAccessor) context.renderer()).flywheel$getLevelRenderState().cameraRenderState.depthFar);
	...
	private static long writeTime(long ptr, RenderContext context) {
		int ticks = (int) (((LevelRendererAccessor) context.renderer()).flywheel$getLevelRenderState().gameTime % Integer.MAX_VALUE);
	...
	private static long writeCullData(long ptr) {
		...
		ptr = writeFloat(ptr, ((LevelRendererAccessor) mc.levelRenderer).flywheel$getLevelRenderState().cameraRenderState.depthFar); // zFar
